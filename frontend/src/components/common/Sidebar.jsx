      ...
      <div className="sticky top-0 left-0 h-screen flex flex-col border-r border-gray-700 w-20 md:w-full">
        ...
        <ul className="flex flex-col gap-3 mt-4">
          <li className="flex justify-center md:justify-start">
            ...
            >
              <MdHomeFilled className="w-6 h-5" />
          ...
          <li className="flex justify-center md:justify-start">
            <Link
              ...
              className="flex gap-3 items-center hover:bg-primary transition-all rounded-full duration-300 py-2 pl-2 pr-4 max-w-fit cursor-pointer"
            >
              <IoNotifications className="w-6 h-5" />
        ...
        {authUser && (
          <Link
            to={`/profile/${authUser.username}`}
            className="mt-auto mb-10 flex gap-3 items-start transition-all duration-300 py-4 px-4 rounded-full"
          >
